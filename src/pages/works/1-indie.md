...
- **STEM Academy**: Engineered a real-time question/exam paper creation platform for interfaculty swimming meets.
    - Utilized **Next.js 15**, **Convex**, and **Puppeteer** for real-time question/exam paper creation and high-fidelity PDF document generation.
    - Features a mobile-optimized dashboard for automated generation of question/exam papers.
